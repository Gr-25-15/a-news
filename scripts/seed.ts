...
import { PutObjectCommand, ListBucketsCommand, CreateBucketCommand, HeadBucketCommand } from '@aws-sdk/client-s3';
  ...
  for (const topic of topics) {
    ...
    try {
      ...
      try {
        ...
        console.warn(`AI Generation failed for "${topic}", using fallback content. (Reason: ${aiErr instanceof Error ? aiErr.message : 'Unknown'})`);
